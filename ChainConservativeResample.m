function [Resampled] = ChainConservativeResample(Chain, weight )
%CONSERVATIVERESAMPLE Resample a chain conservatively
...
for ii = 1:Np
    Resampled.particles{ii} = Chain.particles{samp(ii)};
end
Resampled.weights = new_weight;
